...
//     humanChoice = prompt(
//       "Input either Rock, Paper or Scissors (case insensitive)"
//     );
...
//     resultText = "Draw! both players choose" + humanChoice + ".";
//     return resultText;
//     // test cases where human win the match!!!!!!!!!!!!
//   } else if (
...
//   ) {
//     resultText =
//       humanChoice + "beats to" + computerChoice + ",Human wins the match!";
//     humanScore += 1;
//     return resultText;
//   }
//   // test cases where computer win the match!!!!!!!!
//   else if (
